...
public class Feed extends Informacao implements Mensagem{
    ...
    private void PrintarMensagem(int i)
    {
        System.out.println(this.usuarioQueMandou.get(i).getNomeUsuario() + " disse: " + this.mensagemRecebida.get(i));
    }

    public void MostrarFeed(Conta contaQuerVer)
    {
        for (int i = 0; i < this.mensagemRecebida.size(); i++)
        {
