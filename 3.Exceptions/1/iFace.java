...
public class iFace {
    ...
    public void ModificarVisualizacaoFeed(Conta conta)
    {
    ...
    public void EnviarMensagem(Conta conta, Scanner input)  throws Exception
    {
    ...
    public void VerCaixaDeMensagens(Conta conta, Scanner input) throws Exception
    {
        System.out.println("\n\t\t-- Caixa De Mensagens --");
    ...
    public void AdicionarAmigo(Conta conta, Scanner input)  throws Exception
    {
    ...
    public void CriarComunidade(Conta conta, Scanner input) throws Exception
    {
